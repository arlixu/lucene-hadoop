...
class InMemoryDirIndex(
  ...
  sparkSession.experimental.extraOptimizations = new LuceneRule :: Nil
//  sparkSession.experimental.extraStrategies = new LuceneStrategy :: Nil
  ...
  override def equals(other: Any): Boolean = other match {
    case hdfs: InMemoryDirIndex => rootPaths.toSet == hdfs.rootPaths.toSet
    case _ => false
  }
...
//    logWarning("Selected files after partition pruning:\n\t" + selectedPartitions.mkString("\n\t"))
    selectedPartitions
  }
