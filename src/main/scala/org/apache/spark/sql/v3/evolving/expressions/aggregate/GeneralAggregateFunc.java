...
public final class GeneralAggregateFunc implements AggregateFunc {
  ...
  private final V2Expression[] children;

  public GeneralAggregateFunc(String name, boolean isDistinct, V2Expression[] children) {
    this.name = name;
  ...
  @Override
  public V2Expression[] children() { return children; }
}
