...
package org.apache.spark.sql.v3.evolving.expressions.aggregate;
...
public final class Aggregation implements Serializable {
  ...
  private final V2Expression[] groupByExpressions;

  public Aggregation(AggregateFunc[] aggregateExpressions, V2Expression[] groupByExpressions) {
  ...
  public V2Expression[] groupByExpressions() { return groupByExpressions; }
}
