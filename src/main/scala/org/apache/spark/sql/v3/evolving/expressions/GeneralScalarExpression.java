 ...
 */
@Evolving
public class GeneralScalarExpression implements V2Expression {
  private String name;
  private V2Expression[] children;

  public GeneralScalarExpression(String name, V2Expression[] children) {
    this.name = name;
